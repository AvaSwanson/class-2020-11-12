...
It fits week_10_train so well (overfit) it's no longer useful. It doesn't know how to handle new data. 
...
lm_fit <- fit(mod_1_wfl, week_10_train)

predict(lm_fit, week_10_train %>% filter(poverty_n == 1.5))
